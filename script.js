...
<div class="hidden" id="emoji" style="width:300px;height:0;position:fixed; top: 0%; left: 0;"><iframe
         src="https://giphy.com/embed/LkFPKsp6VqpQAiMiUR" width="300px" height="300px" style="position:absolute"
...
loader(item1);
const text = `Ở đây chúng mình ko có gì ngoài câu nói: ${nameUser} là bịp vương ahihi 😜😜😜`;
